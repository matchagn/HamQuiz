...
import com.hamquiz.service.QuestionService;
...
public class QuestionController {
	...
	public String start(@RequestParam(name = "questionCount", required = false) Integer questionCount,
	...
	public String answer(@RequestParam(name = "id", required = false) Integer id,
			@RequestParam(name = "answer", required = false) Integer answer, Model model) {
